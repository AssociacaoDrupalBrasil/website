...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_day_drupalbrasil_dev.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_day_drupalbrasil_dev.inc');
//</DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/drupalbrasil/day_drupalbrasil_dev-settings.inc');
}
