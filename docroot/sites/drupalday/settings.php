...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_drupalday_drupalbrasil.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_drupalday_drupalbrasil.inc');
//</DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/drupalbrasil/drupalday-settings.inc');
}
