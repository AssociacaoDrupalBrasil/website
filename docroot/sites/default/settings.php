...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'nunesweb_adb',
      'username' => 'nunesweb',
      'password' => 'chysfaVZiOb',
      'host' => '192.186.184.175',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = '2d4c59dfa5fc2aa5013a63547e7088aae6cb51ed';
...
/*
  $conf['redis_client_host'] = '192.186.184.175';
  #$conf['redis_cache_port'] = '6379';

  #$conf['redis_cache_uri'] = 'tcp://192.186.184.175:6379';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_default.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_default.inc');
//</DDSETTINGS>
